...
import {ProtocolliGeos2023Service} from "./protocolli-geos-2023.service";
import {ProtocolliGeos2023Dto} from "./protocolli-geos-2023-dto";
@Component({
  selector: 'app-protocolli-geos',
  templateUrl: './protocolli-geos-2023.component.html',
  styleUrls: ['./protocolli-geos-2023.component.css'],
  providers: [],
  encapsulation: ViewEncapsulation.None,

})
export class ProtocolliGeos2023Component implements OnInit{

  dataDialog: boolean;
  newDialog: boolean;
  dataShowDialog: boolean;
  selectedIdProt: number;
  datas: ProtocolliGeos2023Dto[];
  data: ProtocolliGeos2023Dto;
  selectedDatas: ProtocolliGeos2023Dto[];
  selectedData: ProtocolliGeos2023Dto;
  ...
  constructor(private fb: FormBuilder, private protocolliGeosService: ProtocolliGeos2023Service,
  ...
  ngOnInit() {
    this.protocolliGeosService.getProtocolliGeos2023().subscribe(data => {
  ...
  editData(data: ProtocolliGeos2023Dto) {
    this.data = {...data};
  ...
  showData(data: ProtocolliGeos2023Dto) {
    this.data = {...data};
  ...
  deleteData(data: ProtocolliGeos2023Dto) {
    if(data.idprot){
